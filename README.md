...
*Mar 2025 - May 2025*  
- Architected a RESTful backend using a Controller-Service-Repository pattern to ensure modularity and scalability, streamlining development through Scrum methodology and GitHub Actions CI/CD pipelines.
- Designed and optimized relational PostgreSQL schemas to ensure data consistency and referential integrity across complex entity relationships, supporting high-concurrency workloads.
- Achieved 100% unit test coverage and validated system reliability by executing integration and performance benchmarks using JUnit, Mockito, and JUnitPerf to meet backend SLAs.

📂 *Explore more projects on my [GitHub](https://github.com/AdriianFdz)*
